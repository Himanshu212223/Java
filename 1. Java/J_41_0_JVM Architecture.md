...
- This means a programmer can develop Java code on one system and expect it to run on any other Java-enabled system without any adjustments. This is all possible because of the JVM. 
...
![](./Screenshots/J_41_JVMArchitecture.png)


## 2. Core Components Of JVM
...
#### 2.1.2. **Linking:** Performs verification, preparation, and (optionally) resolution.
...
- In general, there are three class loaders:  
    ...
    ```
    System.out.println(Class_Name.class.getClassLoader());
    ```
...
![](./Screenshots/J_41_classLoader.png)




### 2.3. JVM Memory Areas
...
>
>A native method is a method that is declared in Java but implemented in another language (like C or C++).
>
> It is marked with the native keyword and has no body in Java.

![](./Screenshots/J_41_Memory.png)
...
> #### Native Code : 
>
> In Java, native code refers to the code that is written in a language other than Java (typically C or C++) and is executed directly by the operating system, not by the Java Virtual Machine (JVM).
