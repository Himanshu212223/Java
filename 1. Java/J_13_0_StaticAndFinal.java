...
public class J_13_0_StaticAndFinal {
...
//		System.out.println(number1);		//	This will throw error becz, cannot use non-static member without object.
			...
			System.out.println(J_13_0_StaticAndFinal.number2) ;		//	Static can be used with class name.
			
			//	Lets make the object of class StaticKeyWord.
			J_13_0_StaticAndFinal skw = new J_13_0_StaticAndFinal() ;
